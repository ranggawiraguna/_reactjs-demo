      ...
      <Container id="Redux_Implementation">
        <Provider store={Store}>
          <ExampleApp>
            ...
            <SectionContainer>
              <Switch>
                <Route exact path="/State-Management/Redux/Implementation" component={SectionDashboard} />
                <Route exact path="/State-Management/Redux/Implementation/Cart" component={SectionCart} />
                <Route exact path="/State-Management/Redux/Implementation/Favorite" component={SectionFavorite} />
              </Switch>
            </SectionContainer>
          </ExampleApp>
        </Provider>
