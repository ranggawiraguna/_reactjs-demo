    ...
    <Frame>
      <Container id="State_Management_Redux">
        ...
        <ContainerListSection>
          <CardSection
            linkTo="/State-Management/Redux/Basic-State"
            icon="https://img.icons8.com/nolan/452/four-squares.png"
            title="Basic Redux"
            definition="Berisi fungsi dan juga state berupa object yang ada dalam membuat state management menggunakan redux. masing masing state/object memiliki peran masing-masing dalam melakukan tugas pada state manajemen. pada bagian ini akan dibahas dasar dari fungsi/state yang ada pada redux untuk melakukan suatu state manajemen"
          />
          <CardSection
            linkTo="/State-Management/Redux/Implementation"
