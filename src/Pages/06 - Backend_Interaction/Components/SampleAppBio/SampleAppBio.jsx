  ...
  return (
    <div className="sample-app-bio">
      <div className="bio-profile">
        ...
        {props.bio.split("\n").map(text => <p key={Math.random()} className="bio-info-bio">{text}</p>)}
      </div>
